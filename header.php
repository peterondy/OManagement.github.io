...
<header class="row" style="margin: 0 !important">
  <nav class="navbar float-start navbar-expand-lg navbar-light bg-light col-md-12">
    <div class="container-fluid col-md-9 col-sm-9">
      <a class="fs-2" href="index.php">Online Management</a>
    </div>
      <a href="login.php" id="login" class="col-md-1 col-sm-2">Login</a>
      
      <button class="btn float-end bg-c-yellow ml-1 col-md-1" style="background-color: #f7cd6e !important; padding-top: 0; padding-bottom: 0;" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
